...
class OrderRequest(BaseModel):
    ...
    valueQuantity: Optional[float] = Field(None, description="Value Quantity")
    price: Optional[float] = Field(None, description="Price")
    priceType: Optional[str] = Field(None, description="Price Type (INPUT, MARKET)")
    ...
    tpTriggerBy: Optional[str] = Field(None, description="Take Profit Trigger Type (MARK_PRICE, CONTRACT_PRICE)")
    tpLimitPrice: Optional[float] = Field(None, description="Take Profit Limit Price")
    tpOrderType: Optional[str] = Field(None, description="Take Profit Order Type (MARKET, LIMIT)")
    stopLoss: Optional[float] = Field(None, description="Stop Loss Price")
    slTriggerBy: Optional[str] = Field(None, description="Stop Loss Trigger Type (MARK_PRICE, CONTRACT_PRICE)")
    slLimitPrice: Optional[float] = Field(None, description="Stop Loss Limit Price")
    slOrderType: Optional[str] = Field(None, description="Stop Loss Order Type (MARKET, LIMIT)")
    category: Optional[str] = Field(None, description="Category (USDC, default USDT)")
...
class FuturesOrderRequest(BaseModel):
    ...
    valueQuantity: Optional[float] = Field(None, description="Value quantity")
    priceType: Optional[str] = Field(None, description="Price type")
    stopPrice: Optional[float] = Field(None, description="Stop price")
    timeInForce: Optional[str] = Field(None, description="Time in force")
    takeProfit: Optional[float] = Field(None, description="Take profit")
    tpTriggerBy: Optional[str] = Field(None, description="Take profit trigger by")
    stopLoss: Optional[float] = Field(None, description="Stop loss")
    slTriggerBy: Optional[str] = Field(None, description="Stop loss trigger by")
